...
API_ARGUMENTS_ERROR = _("'--api' argument is missing. The supplied arguments are not valid")
INTERACTIVE_ARGUMENTS_ERROR = _("'--interactive' argument is missing. The '--default' argument is not valid")
