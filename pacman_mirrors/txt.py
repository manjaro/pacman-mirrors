...
# CANNOT_UPDATE_FILE = _("Cannot update file")
...
# MIRROR_HTTP_EXCEPTION = _("Cannot read server response")
# MIRROR_NOT_AVAILABLE = _("server not available")
# MIRROR_NOT_REACHABLE = _("Failed to reach server")
# MIRROR_UNKNOWN_ERROR = _("The server did not complete the request")
MIRROR_LIST_SAVED = _("Mirrorlist generated and saved to")
MUST_BE_ROOT = _("Must have root privileges")
# NETWORK_DOWN = _("The network appears to be down")
NO_CHANGE = _("The mirror list is not changed")
# NO_MIRRORS_AVAILABLE = _("No mirrors available")
NO_SELECTION = _("No mirrors in selection")
OPTION = _("Option")
# WRITING_CUSTOM_FILE = _("Writing custom mirror file")
WRITING_MIRROR_LIST = _("Writing mirror list")
# QUERY_ALL_MIRRORS = _("Querying all mirrors")
# QUERY_CUSTOM_MIRRORS = _("Querying custom mirrors")
...
# RESET_MIRROR_LIST = _("Use `pacman-mirrors -c all` to reset list")
